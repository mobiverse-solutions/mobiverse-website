    ...
    <body x-data="{ Form: false }" class="dark:bg-black">
            ...
            <div class="dark:bg-gray-800 bg-rose-50 h-full w-full">
                <div class="max-w-screen-xl mx-auto px-8 sm:px-16">
                    <div class="pt-24 text-center md:pt-40">
                        ...
                        <p
                            class="text-gray-500  py-6 text-md leading-[27px] md:text-xl sm:w-3/4 mx-auto dark:text-white">
                            Reach your
                            customers
                    ...
                    <div class=" pt-8 py-10 md:pb-28 border border-gray-100 dark:border-none dark:hidden">
                        <img class="rounded-lg shadow-xl" src="./images/mobimessenger_dashboard_image.png"
                            alt="mobimessenger_dashboard_image">
                    </div>
                    <div class=" pt-8 py-10 md:pb-28 dark:block hidden border border-gray-100 dark:border-none">
        ...
        <section id="features" class="max-w-screen-xl mx-auto px-8 sm:px-16 py-16">
            ...
            <div class=" text-center sm:pt-8">
                ...
                <p class="text-gray-500 pt-6 sm:pt-4 md:pt-6 dark:text-white">Powerful messaging capabilities designed
                    for businesses of
                    all
                    sizes</p>
            </div>
            ...
            transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                    <div class="py-8 px-8 md:pt-10">
                        ...
                        <p class="font-bold md:pb-2 text-md md:text-xl dark:text-white">Bulk SMS Campaigns</p>
                        <!-- </div> -->
            ...
            transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                    <div class="py-8 px-8 md:pt-10">
                        ...
                        <p class="font-bold md:pb-2 text-md md:text-xl dark:text-white">Transactional Messaging via API
                        </p>
                        <!-- </div> -->
            ...
            rounded-xl h-full transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                    <div class="py-8 px-8 md:pt-10">
                        ...
                        <p class="font-bold md:pb-2 text-md md:text-xl dark:text-white">Real-time Delivery Reports</p>
                        <!-- </div> -->
            ...
            rounded-xl h-full transition duration-300 hover:-translate-y-2 hover:shadow-xl">
                    <div class="py-8 px-8 md:pt-10">
                        ...
                        <p class="font-bold md:pb-2 text-md md:text-xl dark:text-white">Secure & Scalable
                            Infrastructure</p>
                        <!-- </div> -->
            ...
            <div class="dark:bg-gray-800 bg-gray-50 py-20 sm:py-24 ">
                <div class="max-w-screen-xl mx-auto px-8 sm:px-16">
                    ...
                    <div class="text-center ">
                        ...
                        <p class="text-gray-500 pt-4 md:pt-6 dark:text-white">How businesses are using Mobi Messenger
                            to improve
                            customer
                            communication</p>
                    </div>
        ...
        <section id="api">
            <div class="max-w-screen-xl mx-auto px-8 sm:px-16 sm:pt-28 py-20">
                <div class="text-center">
                    ...
                    <p class="text-gray-500 pt-4 sm:pt-2 md:pt-6 dark:text-white">Simple, RESTful APIs with fast
                        onboarding and
...

{
  ...
  "sender_id": "MobiMsg"
        ...
        <section id="pricing" class="">
            <div class="dark:bg-gray-800 bg-gray-50 py-20">
        ...
        <section id="about" class="max-w-screen-xl mx-auto px-8 sm:py-16 py-20">
            <div class="text-center md:pt-12">
                ...
                <p class="pt-2 text-gray-500 md:pt-6 dark:text-white">Here's what sets us apart from other messaging
                    platforms</p>
            </div>
                ...
                <div>
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="dark:text-white">Our direct carrier connections ensure your messages reach their
                                destination.</p>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="dark:text-white">Used by companies of all sizes across multiple industries.</p>
                        </div>
                    </div>
                </div>
        ...
        <footer class="bg-black">
            <section class="max-w-screen-xl mx-auto px-8 pt-10 md:pt-16 sm:px-12">
                <div class="grid md:grid-cols-4 grid-cols-1  md:gap-8 gap-8 md:pb-12"> <!--grid grid-cols-5-->
                    <div>
