...
return [
    ...
    'domain' => null, /*What will be our subdomain name or are we going to maintain the same domain as our app.*/
    ...
    'middleware' => [ /*Is a middleware being used so we can state it in the file. */
        'web',
    ],
     ...
     */
    'tryit' => [
        'enabled' => env('IDOC_TRYIT_ENABLED', true), /*Should it be left as true or false*/
    ],
...
/*Should the logo be in https form like what is the default or we can just use the ./images form*/
    'color' => '',
    ...
    'title' => 'Mobi Messenger API Reference', /*Mobi Messenger API Documentation*/

    'description' => 'Mobi Messenger Api specification and documentation.', /*This Document contains*/
    ...
    'hide_download_button' => false,/*Should this be true or false*/
    ...
    */
    ...
    'servers' => [
        [
            'url' => config('app.url'), /*Will this be the real url for the app? what we place in the .env file?*/
            'description' => 'Documentation generator server.',
        ],
        [
            'url' => 'http://test.example.com', /*Will this be the url for the deployment environment you create*/
    ...
    'tag_groups' => [
        // ["name"=> "Accounts", "tags"=>["Authentication", "Users"]] /*I do not understand what this section means*/
    ],
    ...
    'language-tabs' => [
        'bash' => 'Bash', /*what languages will we have displayed*/
    ...
    'security' => [
        'BearerAuth' => [ /*I am seeing that you can create a 401 response that will be returned when users 
            do not enter the proper bearer token*/
            /*Are using bearer or basic*/
            'type' => 'http',
            'scheme' => 'bearer',
            'bearerFormat' => 'JWT',
        ],
    ...
    |
     */
/*So what routes are we generating documentations for here*/
    'routes' => [
        [
            /*
